package com.clandro.shared.clandro.extrakeys;
 ...
 * <com.clandro.shared.clandro.extrakeys.ExtraKeysView xmlns:android="http://schemas.android.com/apk/res/android"
 ...
 * <p>
 * Clandro app defines the view in res/layout/view_terminal_toolbar_extra_keys and
 ...
 * The {@link ExtraKeysInfo} is created by ClandroAppSharedProperties.setExtraKeys().
 * Then its got and the view height is adjusted in ClandroActivity.setTerminalToolbarHeight().
 * The client used is ClandroTerminalExtraKeys, which extends
 * {@link com.clandro.x11.utils.ClandroX11ExtraKeys } to handle Clandro app specific logic and
...
public final class ExtraKeysView extends GridLayout {
    ...
    public void reload() {
        ClandroX11ExtraKeys.setExtraKeys();
        ExtraKeysInfo extraKeysInfo = ClandroX11ExtraKeys.getExtraKeysInfo();
