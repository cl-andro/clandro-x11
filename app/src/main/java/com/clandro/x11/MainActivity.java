...
import static com.clandro.x11.CmdEntryPoint.ACTION_START;
import static com.clandro.x11.LoriePreferences.ACTION_PREFERENCES_CHANGED;
...
import com.clandro.x11.input.InputEventSender;
import com.clandro.x11.input.InputStub;
import com.clandro.x11.input.TouchInputHandler;
import com.clandro.x11.utils.FullscreenWorkaround;
import com.clandro.x11.utils.KeyInterceptor;
import com.clandro.x11.utils.ClandroX11ExtraKeys;
import com.clandro.x11.utils.X11ToolbarViewPager;
...
public class MainActivity extends AppCompatActivity {
    public static final String ACTION_STOP = "com.clandro.x11.ACTION_STOP";
    public static final String ACTION_CUSTOM = "com.clandro.x11.ACTION_CUSTOM";

    public static Handler handler = new Handler();
    FrameLayout frm;
    private TouchInputHandler mInputHandler;
    protected ICmdEntryInterface service = null;
    public ClandroX11ExtraKeys mExtraKeys;
    ...
    boolean useClandroEKBarBehaviour = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.help_button).setOnClickListener((l) -> startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/cl-andro/clandro-x11/blob/master/README.md#running-graphical-applications"))));
        ...
        mLorieKeyListener = (v, k, e) -> {
            ...
            if (useClandroEKBarBehaviour && mExtraKeys != null && (dev == null || dev.isVirtual()))
    ...
    void onPreferencesChangedCallback() {
        ...
        useClandroEKBarBehaviour = prefs.useClandroEKBarBehaviour.get();
    ...
    private void setTerminalToolbarView() {
        ...
        layoutParams.height = Math.round(37.5f * getResources().getDisplayMetrics().density *
                (ClandroX11ExtraKeys.getExtraKeysInfo() == null ? 0 : ClandroX11ExtraKeys.getExtraKeysInfo().getMatrix().length));
