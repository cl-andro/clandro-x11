...
public class CmdEntryPoint extends ICmdEntryInterface.Stub {
    public static final String ACTION_START = "com.clandro.x11.CmdEntryPoint.ACTION_START";
    ...
    private Intent createIntent() {
        String targetPackage = getenv("CLANDRO_X11_OVERRIDE_PACKAGE");
        if (targetPackage == null)
            targetPackage = "com.clandro.x11";
        // We should not care about multiple instances, it should be called only by `Clandro:X11` app
