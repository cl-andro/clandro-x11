package com.clandro.x11.utils;

import static com.clandro.shared.clandro.extrakeys.ExtraKeysConstants.PRIMARY_KEY_CODES_FOR_STRINGS;
import static com.clandro.x11.MainActivity.toggleKeyboardVisibility;
...
import com.clandro.shared.clandro.extrakeys.*;
import com.clandro.x11.LoriePreferences;
import com.clandro.x11.MainActivity;

import org.json.JSONException;

public class ClandroX11ExtraKeys implements ExtraKeysView.IExtraKeysView {
    @SuppressWarnings("FieldCanBeLocal")
    private static final String LOG_TAG = "ClandroX11ExtraKeys";
    ...
    public ClandroX11ExtraKeys(@NonNull View.OnKeyListener eventlistener, MainActivity activity, ExtraKeysView extrakeysview) {
    ...
    static final String ACTION_START_PREFERENCES_ACTIVITY = "com.clandro.x11.start_preferences_activity";
    ...
    public static void setExtraKeys() {
        ...
        try {
            ...
            try {
                mExtraKeysInfo = new ExtraKeysInfo(ClandroX11ExtraKeys.DEFAULT_IVALUE_EXTRA_KEYS, "default", ExtraKeysConstants.CONTROL_CHARS_ALIASES);
