...
import com.clandro.x11.utils.SamsungDexUtils;
...
public class LoriePreferences extends AppCompatActivity implements PreferenceFragmentCompat.OnPreferenceStartFragmentCallback {
    static final String ACTION_PREFERENCES_CHANGED = "com.clandro.x11.ACTION_PREFERENCES_CHANGED";
                ...
                if (requireContext().checkSelfPermission(WRITE_SECURE_SETTINGS) != PERMISSION_GRANTED) {
                    new AlertDialog.Builder(requireContext())
                            ...
                            .setMessage("Android requires WRITE_SECURE_SETTINGS permission to start accessibility service automatically.\n" +
                                    ...
                                    "adb shell pm grant com.clandro.x11 android.permission.WRITE_SECURE_SETTINGS")
                ...
                new android.app.AlertDialog.Builder(getActivity())
                        ...
                        .setPositiveButton("OK",
                                (dialog, whichButton) -> {
                                    ...
                                    prefs.extra_keys_config.put(!text.isEmpty() ? text : ClandroX11ExtraKeys.DEFAULT_IVALUE_EXTRA_KEYS);
                                }
                        )
                        .setNeutralButton("Reset",
                                (dialog, whichButton) -> prefs.extra_keys_config.put(ClandroX11ExtraKeys.DEFAULT_IVALUE_EXTRA_KEYS))
    ...
    public static class Receiver extends BroadcastReceiver {
            ...
            try {
                if (intent != null && intent.getExtras() != null) {
                    ...
                    for (String key : intent.getExtras().keySet()) {
                        ...
                        intent0.setPackage("com.clandro.x11");
        ...
        private static void help() {
            System.err.print("clandro-x11-preference [list] {key:value} [{key2:value2}]...");
            System.exit(0);
        }
